...
Draft a complete patent application based on: **the user's request**
...
- **REVIEWER_MODEL = `gpt-5.6-sol`** — Model used via Codex subagent capability for examiner-style review.
