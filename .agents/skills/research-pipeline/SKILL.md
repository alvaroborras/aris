...
End-to-end autonomous research workflow for: **the user's request**
...
```
$idea-discovery "the user's request"
```
...
```
$auto-review-loop "the user's request — [chosen idea title], difficulty: $REVIEWER_DIFFICULTY"
```
