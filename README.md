...
🎯 **Preparing for 2026 AI recruiting?** → [**🌐 ARIS-in-AI-Offer**](https://wanshuiyin.github.io/ARIS-in-AI-Offer/) · [GitHub repo](https://github.com/wanshuiyin/ARIS-in-AI-Offer) · [Chinese README](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/main/README_CN.md) — 23 bilingual ML / LLM / multimodal / generative / agent interview cheat sheets, each with derivations, from-scratch PyTorch, and 25 high-frequency interview questions (L1 / L2 / L3), all auto-generated by ARIS `/render-html`. **Wishing everyone a lighter recruiting season 🌱**
...
<tr>
<td align="center"><b><a href="https://github.com/tianyilt/claude-fleet">Claude Fleet</a></b> · full-featured web dashboard</td>
<td align="center"><b><a href="aris-monitor/">ARIS-Monitor</a></b> · minimal floating widget (built in)</td>
</tr>
</table>
...
> <details><summary>Per-release details (v0.4.5 → v0.4.21)</summary>
>
...
[English README](README.md) | [Chinese README](README_CN.md)
...
<details>
<summary>Earlier updates (2026-03-12 — 2026-06-19, 74 entries)</summary>
...
📝 **Blog post:** [Claude Code NeurIPS guide after two months](http://xhslink.com/o/7IvAJQ41IBA)
...
📝 **Blog post:** [Open source | Claude runs experiments and rewrites papers while you sleep](http://xhslink.com/o/5cBMTDigNXz)
...
> 📖 **New to ARIS?** [`SETUP_GUIDE.md`](SETUP_GUIDE.md) ([Chinese version](SETUP_GUIDE_CN.md)) gives a prescriptive 6-step walkthrough for macOS local + remote Linux GPU server with Claude Code + Codex MCP — the recommended path. The section below is a quick reference; deeper GPU / customization / model-combo setup lives in the linked docs.
